#!/usr/bin/env python3
"""
4.5_upload_purchased_cost_components_oahu.py

Uploads purchased_cost_components.csv into Postgres
(oahu.purchased_cost_components) via a single `psql \\copy` transaction.
...
On a successful upload, purchased_cost_components.csv is deleted and any
source PDFs still sitting in purchased_component\\ are archived to
...
Usage:
    python 4.5_upload_purchased_cost_components_oahu.py
"""
...
CSV_PATH = CSV_DIR / "purchased_cost_components.csv"
