#!/usr/bin/env python3
"""
4.6_upload_purchased_composite_oahu.py

Uploads purchased_composite.csv into Postgres (oahu.purchased_composite) via
a single `psql \\copy` transaction.
...
On a successful upload, purchased_composite.csv is deleted and any source
PDFs still sitting in purchased_component\\ are archived to
...
Usage:
    python 4.6_upload_purchased_composite_oahu.py
"""
...
CSV_PATH = CSV_DIR / "purchased_composite.csv"
