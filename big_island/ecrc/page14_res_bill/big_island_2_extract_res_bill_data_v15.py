...
v15 changes vs v14:
- Added support for older HELCO PDF format (pre-2020):
    * No Interim Rate Adjustment row
    * 11 rate values instead of 12
    * 14 charge values instead of 15
    * Format auto-detected by rate count

Requirements:
    pip install pdfplumber

Usage:
    python big_island_2_extract_res_bill_data_v15.py
"""
